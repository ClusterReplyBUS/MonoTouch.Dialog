...
//			};
			SmoothedBIView dv = new SmoothedBIView(new RectangleF (50, 500, signatureController.View.Frame.Width - 100, signatureController.View.Frame.Height - 600)){
			...
			RectangleF frame = new RectangleF (20, 20, signatureController.View.Frame.Width - 40, 420);
