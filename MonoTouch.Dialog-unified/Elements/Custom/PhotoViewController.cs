...
namespace MonoTouch.Dialog
{
    public partial class PhotoViewController : UIViewController
    {
        ...
        private UINavigationController FindNavigationController(UIViewController viewController)
        {
            if (viewController != null)
            {
                ...
                {
                    var nc = FindNavigationController(child);
                    if (nc != null)
                        return nc;
                }
            }
                      ...
                      BeginInvokeOnMainThread(() =>
                        {
                            ...
                            //if (nav == null)
                                //nav = FindNavigationController(UIApplication.SharedApplication.KeyWindow.RootViewController);
