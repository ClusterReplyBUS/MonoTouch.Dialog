...
{
	public class NSDateInlineElement : DateTimeElement
	{
		...
		public NSDateInlineElement(string caption, NSDate date)
			: base(caption, date)
		{	}
		...
		public override void Selected(DialogViewController dvc, UITableView tableView, NSIndexPath path)
		{
			if(datePicker == null)
			{
				...
				// Whenever the DatePicker is changed, get the NSDateElement cell and change the text.
    ...
    //{
    //    public TaggedDateElement(string caption, NSDate date) : base(caption, date) { }
    //    public object Tag { get; set; }
    //    public bool IsMandatory { get; set; }
    //    private UIColor _defaultColor = UIColor.White;
